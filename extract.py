...
def extract_frames(video_file, output_dir):
    ...
    frame_width = int(cap.get(3) )  # Half the original width
    frame_height = int(cap.get(4))  # Half the original height
...
for video_file in os.listdir(video_directory):
    if video_file.endswith((".mp4", ".avi")):  # Add more video file extensions as needed
        ...
        output_dir = os.path.join(video_directory+"frames/", output_subdirectory)
        print(output_dir)
